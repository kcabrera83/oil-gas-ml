...
def test_models():
    results = {}
    results['quality'] = evaluate_model(os.path.join(MODEL_DIR, 'quality_classifier.pkl'), X, y)
    results['market_value'] = evaluate_model(os.path.join(MODEL_DIR, 'market_value_model.pkl'), X, y)
    return results
